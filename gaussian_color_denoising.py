...
parser.add_argument('--test_file_path', default='./data/GaussianTestData/Color/Kodak24', type=str, help='directory of test dataset')
...
parser.add_argument('--validation_file_path', default='./data/GaussianTestData/Color/McMaster', help='validation file path')
...
import torch
from src.training import ColorTrainer
from src.dataset import ColorDataLoader
...
if __name__ == '__main__':
    ...
    if args.load_model:
        ...
        _model = NODEImgNet(args)
    loader = ColorDataLoader(args)
    _loss = Loss(args)
    ckp = checkpoint(args)
    t = ColorTrainer(args, loader, _model, _loss, device, ckp)
