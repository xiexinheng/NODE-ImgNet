...
parser.add_argument('--test_file_path',
                    default='./data/GaussianTestData/Color/Kodak24', type=str, help='Path of test dataset')
parser.add_argument('--data_test', type=str,
                    default='Kodak24', help='Name of the test dataset')
parser.add_argument('--validation_file_path',
                    default='./data/GaussianTestData/Color/McMaster', help='Path of the validation data')
